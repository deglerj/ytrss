		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="${param.active == 1 ? 'active' : ''}"><a href="${base}"><i class="glyphicon glyphicon-download"></i> Downloads</a></li>
					<li class="dropdown ${param.active == 2 ? 'active' : ''}">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="https://github.com/deglerj/ytrss"><i class="glyphicon glyphicon-globe"></i> ytrss 0.0.6a</a></li>
				</ul>
			</div>
		</div>
	</div>